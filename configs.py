...
class Config(object):
    ...
    BOT_SESSION_NAME = os.environ.get("BOT_SESSION_NAME", "Teraboxlinksearch_bot")
    USER_SESSION_STRING = os.environ.get("USER_SESSION_STRING", "Teraboxlinksearch_bot")
    CHANNEL_ID = int(os.environ.get("CHANNEL_ID", ))
    BOT_USERNAME = os.environ.get("Teraboxlinksearch_bot")
